...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Ahana Dasgupta — Computer Science undergraduate working across data analysis, cloud data engineering, and software development with Python, PySpark, SQL, and modern web stacks." },
      { name: "author", content: "Ahana Dasgupta" },
